...
- *(core)* make validator diagnostics policy spec-driven

## [0.1.13](https://github.com/trevordcampbell/zpl-toolchain/compare/v0.1.12...v0.1.13) - 2026-02-14

### Added

- *(release)* automate Homebrew tap sync and complete DX preflight updates
...
- *(cli)* clarify transport selection and minimal build options

## [0.1.10](https://github.com/trevordcampbell/zpl-toolchain/compare/v0.1.9...v0.1.10) - 2026-02-12

### Fixed

- *(cli)* harden serial/bt diagnostics for flaky transport lifecycles

## [0.1.9](https://github.com/trevordcampbell/zpl-toolchain/compare/v0.1.8...v0.1.9) - 2026-02-12

### Fixed

- *(cli)* add richer serial probe forensics and bluetooth status inspector
- *(print-client)* improve serial trace correlation and ~HI memory parsing
...
- *(ci)* convert release.yml to workflow_dispatch, add testing guide

## [0.1.4](https://github.com/trevordcampbell/zpl-toolchain/compare/v0.1.3...v0.1.4) - 2026-02-09

### Other

- add workspace lint config, complete docs, polish metadata

## [0.1.3](https://github.com/trevordcampbell/zpl-toolchain/compare/v0.1.2...v0.1.3) - 2026-02-09

### Other

- add package READMEs and metadata for all published packages
